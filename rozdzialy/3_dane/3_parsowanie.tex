...
\begin{figure}[!h]
    \begin{minipage}[c]{0.3\linewidth}
        \includegraphics[width=\linewidth,height=.8\linewidth]{\chapterPath/img/page_map.png}
        \caption{\small Fragment pliku page.map z tytułami}
        \label{fig:page-map}
    \end{minipage}
    \begin{minipage}[c]{0.7\linewidth}
        \includegraphics[width=\linewidth,height=.8\linewidth]{\chapterPath/img/pagelinks_map.png}
