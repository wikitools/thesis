\begin{chapter}{Implementacja głównej aplikacji WikiGraph}
	...
	\input{\chapterPath/1_model.tex}
	\input{\chapterPath/2_reprez_wizualna.tex}
	\input{\chapterPath/3_tryby_widoki.tex}
	\input{\chapterPath/4_0_elementy.tex}
	\input{\chapterPath/4_historia_trasy.tex}
	\input{\chapterPath/5_integracja_cave.tex}
	\input{\chapterPath/5_0_pamiec.tex}
	\input{\chapterPath/6_konsola.tex}
	\input{\chapterPath/7_Linia_czasu.tex}
\end{chapter}
