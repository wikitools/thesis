...
Załadowane węzły są dodawane jako wartości w mapie \codeinline{ID} $\,\to\,$ \codeinline{Node}, co pozwala na późniejsze szybkie uzyskanie modelu na podstawie jego identyfikatora. Przechowywanie grafu w pamięci zostanie szczegółowo opisane w sekcji \ref{sec:graf-reprezentacja}.
