...
\img{\chapterPath/img/header1.png}{Nagłówek po wskazaniu węzła}{header1}{.65}
...
\img{\chapterPath/img/header2.png}{Nagłówek w widoku węzła z informacją o połączeniach}{header2}{.65}
...
\img{\chapterPath/img/header3.png}{Nagłówek z ikoną stanu sygnalizującą trwające automatyczne przemierzanie trasy}{header3}{.65}
