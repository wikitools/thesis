...
\img{\chapterPath/img/billboard-schema.png}{Poglądowy schemat ilustrujący problem, widok z góry\\ (prawidłowa skala nie została przedstawiona)}{billboard-schema}{.65}
